...
public:
	...
	// virtual void fillPoly(float* points, float* texcoords, size_t number, Bitmap& bitmap);
	...
	// virtual void fillRect   (float x, float y, float w, float h, Bitmap& bitmap);
	...
	// virtual void fillRRect   (float radius, float degree, float x, float y, float w, float h, Bitmap& bitmap);
};
